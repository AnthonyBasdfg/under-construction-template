...
import { ConstructionLogo } from "@/components/ConstructionLogo"
...
const FiverrIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 508.02 508.02" className={className}>
        ...
        <Card className="border-slate-800 bg-slate-950/60 backdrop-blur-sm">
          ...
          <CardHeader className="text-center space-y-1">
            <div className="mx-auto flex justify-center">
              <ConstructionLogo className="w-32 h-32" /> {/* Increased from w-24 h-24 to w-32 h-32 */}
            </div>
            <CardTitle className="text-2xl font-bold text-white mt-2"> {/* Added mt-2 to reduce space */}
